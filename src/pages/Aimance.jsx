  ...
  return (
    <ReactLenis root>
      <div className="sample-project">
        ...
        <section className="py-4 md:py-16 flex justify-center">
          <div className="relative w-[90%] md:w-[80%] h-[40vh] md:h-[60vh] aspect-video rounded-2xl overflow-hidden border-0">
            <iframe
