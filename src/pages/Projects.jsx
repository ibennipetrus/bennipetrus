...
const Projects = () => {
  const projectData = [
    ...
    { title: "Spotify", path: "/Spotify", copy: "Vibes Unlimited", year: 2025 },
    {
  ...
  // Sortiere die Projekte nach Jahr absteigend **vor** dem Scramble
  const sortedProjects = projectData.sort(
    (a, b) => Number(b.year) - Number(a.year)
  );

  const scrambledProjects = useMultipleScrambles(sortedProjects);

  return (
    <div className="w-full md:w-3/4 mx-auto px-4 py-4 md:py-40 pb-[250px]">
